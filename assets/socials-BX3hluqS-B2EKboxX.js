import{c as S,l as A,V as h,m as $,_ as n,v as d,J as E,d as u,a as b,L as C,n as O,t as P,Z as g,i as y,H as R,p as U,q as _,g as k,N as W,Q as c,u as F,W as D,w as N,x as q,y as z,s as I}from"./index-BsMns30z.js";const G=k`
  :host {
...
`;var v=function(e,t,o,r){var s=arguments.length,i=s<3?t:r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let p=class extends S{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=F.state.plan.hasExceededUsageLimit,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;let t=((e=this.remoteFeatures)==null?void 0:e.socials)||[];const o=!!this.authConnector,r=t?.length,s=g.state.view==="ConnectSocials";return(!o||!r)&&!s?null:(s&&!r&&(t=D.DEFAULT_SOCIALS),n` <wui-flex flexDirection="column" gap="2">
      ${t.map(i=>n`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){g.push("UsageExceeded");return}e&&await N(e)}async handlePwaFrameLoad(){var e;if(b.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof q&&await this.authConnector.provider.init()}catch(t){z.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:t.message},"error")}finally{this.isPwaLoading=!1}}}};p.styles=G;v([W()],p.prototype,"tabIdx",void 0);v([c()],p.prototype,"connectors",void 0);v([c()],p.prototype,"authConnector",void 0);v([c()],p.prototype,"remoteFeatures",void 0);v([c()],p.prototype,"isPwaLoading",void 0);v([c()],p.prototype,"hasExceededUsageLimit",void 0);p=v([I("w3m-social-login-list")],p);const j=k`
  wui-flex {
...
`;var T=function(e,t,o,r){var s=arguments.length,i=s<3?t:r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let L=class extends S{constructor(){super(),this.unsubscribe=[],this.checked=A.state.isLegalCheckboxChecked,this.unsubscribe.push(A.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const{termsConditionsUrl:t,privacyPolicyUrl:o}=h.state,r=(e=h.state.features)==null?void 0:e.legalCheckbox,s=!!(t||o)&&!!r&&!this.checked,i=s?-1:void 0;return n`
    ...
    `}};L.styles=j;T([c()],L.prototype,"checked",void 0);L=T([I("w3m-connect-socials-view")],L);const M=k`
  wui-logo {
    width: 80px;
    height: 80px;
