import{c as P,v as y,Z as $,_ as u,F as h,C as E,a as _,H as M,d as O,o as F,$ as K,g as I,Q as l,N as w,G as V,k as Q,W as H,s as A}from"./index-BsMns30z.js";import{a as n}from"./SwapController-CNHVjC6V-DrzMzne8.js";import"./index-DnKQlXMR-AIPMftej.js";const q={numericInputKeyDown(e,t,o){const a=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,r=i.toLocaleLowerCase(),c=r==="a",D=r==="c",U=r==="v",R=r==="x",N=i===",",j=i===".",z=i>="0"&&i<="9";!s&&(c||D||U||R)&&e.preventDefault(),t==="0"&&!N&&!j&&i==="0"&&e.preventDefault(),t==="0"&&z&&(o(i),e.preventDefault()),(N||j)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!z&&!a.includes(i)&&!j&&!N&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
