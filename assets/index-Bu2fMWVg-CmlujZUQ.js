import{a5 as Ee,ab as y,I as k,b as z,e as R,x,i as _,F as ke,C as m,ac as I,z as A,d as N,H as G,a9 as Ne,aa as Te,c as P,J as E,S as l,m as g,D as Se,ad as be,Z as M,ae as Pe,af as Ce,ag as $e,V as re,ah as de,_ as O,q as xe,B as _e,O as b,Q as h,P as Re,W as Oe,y as pe,s as C}from"./index-DYqKnSl7.js";const Ue=O`
  :host {
    position: relative;
  }
...
`;var B=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let S=class extends P{constructor(){super(),this.unsubscribe=[],this.amount=c.state.amount,this.namespace=void 0,this.paymentAsset=c.state.paymentAsset,this.activeConnectorIds=E.state.activeConnectorIds,this.caipAddress=void 0,this.exchanges=c.state.exchanges,this.isLoading=c.state.isLoading,this.initializeNamespace(),this.unsubscribe.push(c.subscribeKey("amount",e=>this.amount=e)),this.unsubscribe.push(E.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e)),this.unsubscribe.push(c.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(c.subscribeKey("isLoading",e=>this.isLoading=e)),c.fetchExchanges(),c.setSelectedExchange(void 0)}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    >
      ...
      `)}templateSeparator(){return l`<wui-separator text="or" bgColor="secondary"></wui-separator>`}async onWalletPayment(){if(!this.namespace)throw new Error("Namespace not found");this.caipAddress?M.push("PayQuote"):(await E.connect(),await G.open({view:"PayQuote"}))}onExchangePayment(e){c.setSelectedExchange(e),M.push("PayQuote")}async onDisconnect(){try{await N.disconnect(),await G.open({view:"Pay"})}catch{console.error("Failed to disconnect"),_.showError("Failed to disconnect")}}getWalletProperties({namespace:e}){if(!e)return{name:void 0,image:void 0};const t=this.activeConnectorIds[e];if(!t)return{name:void 0,image:void 0};const i=E.getConnector({id:t,namespace:e});if(!i)return{name:void 0,image:void 0};const s=k.getConnectorImage(i);return{name:i.name,image:s}}};S.styles=st;B([h()],S.prototype,"amount",void 0);B([h()],S.prototype,"namespace",void 0);B([h()],S.prototype,"paymentAsset",void 0);B([h()],S.prototype,"activeConnectorIds",void 0);B([h()],S.prototype,"caipAddress",void 0);B([h()],S.prototype,"exchanges",void 0);B([h()],S.prototype,"isLoading",void 0);S=B([C("w3m-pay-view")],S);const nt=O`
  :host {
    display: inline-flex;
    align-items: center;
    justify-content: center;
