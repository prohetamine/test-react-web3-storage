import{x as g,B as d,V as e,I as c,q as s,W as u}from"./property-Bd8U3_QP-CBnpnfGE.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,h,i)=>{for(var r=i>1?void 0:i?y(l,h):l,p=a.length-1,n;p>=0;p--)(n=a[p])&&(r=(i?n(l,h,r):n(r))||r);return i&&r&&w(l,h,r),r};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return d`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([u("ph-arrow-right")],t);export{t as PhArrowRight};
