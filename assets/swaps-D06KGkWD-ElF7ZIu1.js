import{c as P,v as y,Z as $,_ as u,F as h,D as E,a as _,H as M,d as O,o as F,g as K,k as I,Q as l,N as w,G as V,l as Q,W as H,s as A}from"./index-BCiuqpef.js";import{a as n}from"./SwapController-CmWZu4cY-Bm2PgnoE.js";import"./index-D8W2bJl5-Bvg6UvhZ.js";const q={numericInputKeyDown(e,t,o){const a=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,r=i.toLocaleLowerCase(),c=r==="a",D=r==="c",U=r==="v",R=r==="x",N=i===",",j=i===".",z=i>="0"&&i<="9";!s&&(c||D||U||R)&&e.preventDefault(),t==="0"&&!N&&!j&&i==="0"&&e.preventDefault(),t==="0"&&z&&(o(i),e.preventDefault()),(N||j)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!z&&!a.includes(i)&&!j&&!N&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
...
`;var T=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};const J=5e-5;let f=class extends P{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return u`
      <wui-flex
