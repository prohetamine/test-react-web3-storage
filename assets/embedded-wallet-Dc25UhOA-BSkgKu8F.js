import{c as f,H as j,V as H,S as c,J as T,L as V,t as L,e as P,R as q,Z as G,f as Q,a as x,C as h,U as N,p as X,z,b as O,o as k,$ as g,i as J,T as M,d as Z,r as ee,j as _,W as Y,Q as l,_ as E,q as D,B as F,O as d,m as te,s as w}from"./index-Cu-0-v6d.js";const oe=Y`
  div {
    width: 100%;
  }
...
`;var y=function(e,t,i,s){var r=arguments.length,o=r<3?t:s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};const ne={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},se={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let u=class extends f{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return c`
    ...
    `}};W=ae([w("w3m-upgrade-wallet-view")],W);var A=function(e,t,i,s){var r=arguments.length,o=r<3?t:s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let $=class extends f{constructor(){super(...arguments),this.loading=!1,this.switched=!1,this.text="",this.network=h.state.activeCaipNetwork}render(){return c`
    ...
    `)}async changePreferredAccountType(){var e;const t=(e=this.network)==null?void 0:e.chainNamespace,i=h.checkIfSmartAccountEnabled(),s=k(t)===g.ACCOUNT_TYPES.SMART_ACCOUNT||!i?g.ACCOUNT_TYPES.EOA:g.ACCOUNT_TYPES.SMART_ACCOUNT;T.getAuthConnector()&&(this.loading=!0,await Z.setPreferredAccountType(s,t),this.text=s===g.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account",this.switched=!0,ee.resetSend(),this.loading=!1,this.requestUpdate())}};A([l()],$.prototype,"loading",void 0);A([l()],$.prototype,"switched",void 0);A([l()],$.prototype,"text",void 0);A([l()],$.prototype,"network",void 0);$=A([w("w3m-smart-account-settings-view")],$);const ce=E`
  :host {
    width: 100%;
  }
...
`;var S=function(e,t,i,s){var r=arguments.length,o=r<3?t:s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let m=class extends f{constructor(){super(...arguments),this.disabled=!1,this.loading=!1}render(){return c`
      <wui-input-text
        value=${te(this.value)}
      ...
      ></wui-input-text>
    `}};m.styles=[D,de];S([d()],m.prototype,"errorMessage",void 0);S([d({type:Boolean})],m.prototype,"disabled",void 0);S([d()],m.prototype,"value",void 0);S([d({type:Boolean})],m.prototype,"loading",void 0);S([d({attribute:!1})],m.prototype,"onKeyDown",void 0);m=S([w("wui-ens-input")],m);const le=E`
  wui-flex {
    width: 100%;
  }
...
`;var v=function(e,t,i,s){var r=arguments.length,o=r<3?t:s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends f{constructor(){var e;super(),this.formRef=Q(),this.usubscribe=[],this.name="",this.error="",this.loading=x.state.loading,this.suggestions=x.state.suggestions,this.profileName=(e=h.getAccountData())==null?void 0:e.profileName,this.onDebouncedNameInputChange=P.debounce(t=>{t.length<4?this.error="Name must be at least 4 characters long":N.isValidReownName(t)?(this.error="",x.getSuggestions(t)):this.error="The value is not a valid username"}),this.usubscribe.push(x.subscribe(t=>{this.suggestions=t.suggestions,this.loading=t.loading}),h.subscribeChainProp("accountState",t=>{this.profileName=t?.profileName,t!=null&&t.profileName&&(this.error="You already own a name")}))}firstUpdated(){var e;(e=this.formRef.value)==null||e.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){var e;super.disconnectedCallback(),this.usubscribe.forEach(t=>t()),(e=this.formRef.value)==null||e.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
    ...
    </wui-flex>`}isAllowedToSubmit(e){var t;const i=(t=e.split("."))==null?void 0:t[0],s=this.suggestions.find(r=>{var o,n;return((n=(o=r.name)==null?void 0:o.split("."))==null?void 0:n[0])===i&&r.registered});return!this.loading&&!this.error&&!this.profileName&&i&&x.validateName(i)&&!s}async onSubmitName(e){try{if(!this.isAllowedToSubmit(e))return;O.sendEvent({type:"track",event:"REGISTER_NAME_INITIATED",properties:{isSmartAccount:k(h.state.activeChain)===g.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}}),await x.registerName(e),O.sendEvent({type:"track",event:"REGISTER_NAME_SUCCESS",properties:{isSmartAccount:k(h.state.activeChain)===g.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e}})}catch(t){J.showError(t.message),O.sendEvent({type:"track",event:"REGISTER_NAME_ERROR",properties:{isSmartAccount:k(h.state.activeChain)===g.ACCOUNT_TYPES.SMART_ACCOUNT,ensName:e,error:P.parseError(t)}})}}onEnterKey(e){if(e.key==="Enter"&&this.name&&this.isAllowedToSubmit(this.name)){const t=`${this.name}${z.WC_NAME_SUFFIX}`;this.onSubmitName(t)}}};p.styles=le;v([d()],p.prototype,"errorMessage",void 0);v([l()],p.prototype,"name",void 0);v([l()],p.prototype,"error",void 0);v([l()],p.prototype,"loading",void 0);v([l()],p.prototype,"suggestions",void 0);v([l()],p.prototype,"profileName",void 0);p=v([w("w3m-register-account-name-view")],p);const ue=Y`
...
`;var pe=function(e,t,i,s){var r=arguments.length,o=r<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,i):s,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o};let U=class extends f{render(){return c`
    ...
    </wui-flex>`}redirectToAccount(){G.replace("Account")}};U.styles=ue;U=pe([w("w3m-register-account-name-success-view")],U);export{C as W3mApproveTransactionView,U as W3mRegisterAccountNameSuccess,p as W3mRegisterAccountNameView,$ as W3mSmartAccountSettingsView,W as W3mUpgradeWalletView};
