import{V as m,Z as h,C as g,i as p,c as y,S as s,D as W,X as E,Y as R,W as $,O as C,Q as u,s as x}from"./index-3pVASmuD.js";import{u as S}from"./index-BsxJaSgz-aW8G0Q-B.js";import{ReownAuthentication as v}from"./features-EquCD-MD-BvlLwN1q.js";const I=$`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var k=function(t,i,a,l){var n=arguments.length,e=n<3?i:l,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,i,a,l);else for(var o=t.length-1;o>=0;o--)(r=t[o])&&(e=(n<3?r(e):n>3?r(i,a,e):r(i,a))||e);return n>3&&e&&Object.defineProperty(i,a,e),e};const q=["@gmail.com","@outlook.com","@yahoo.com","@hotmail.com","@aol.com","@icloud.com","@zoho.com"];let w=class extends y{constructor(){super(...arguments),this.email=""}render(){const t=q.filter(this.filter.bind(this)).map(this.item.bind(this));return t.length===0?null:s`<div class="email-sufixes">${t}</div>`}filter(t){if(!this.email)return!1;const i=this.email.split("@");if(i.length<2)return!0;const a=i.pop();return t.includes(a)&&t!==`@${a}`}item(t){return s`<wui-button variant="neutral" size="sm" @click=${()=>{const i=this.email.split("@");i.length>1&&i.pop();const a=i[0]+t;this.dispatchEvent(new CustomEvent("change",{detail:a,bubbles:!0,composed:!0}))}}
      >${t}</wui-button
    >`}};w.styles=[I];k([C()],w.prototype,"email",void 0);w=k([x("w3m-email-suffixes-widget")],w);const D=$`
  .recent-emails {
    display: flex;
...
`;var A=function(t,i,a,l){var n=arguments.length,e=n<3?i:l,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,i,a,l);else for(var o=t.length-1;o>=0;o--)(r=t[o])&&(e=(n<3?r(e):n>3?r(i,a,e):r(i,a))||e);return n>3&&e&&Object.defineProperty(i,a,e),e};let f=class extends y{constructor(){super(...arguments),this.emails=[]}render(){return this.emails.length===0?null:s`<div class="recent-emails">
    ...
    </wui-list-item>`}};f.styles=[D];A([C()],f.prototype,"emails",void 0);f=A([x("w3m-recent-emails-widget")],f);var O=function(t,i,a,l){var n=arguments.length,e=n<3?i:l,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(t,i,a,l);else for(var o=t.length-1;o>=0;o--)(r=t[o])&&(e=(n<3?r(e):n>3?r(i,a,e):r(i,a))||e);return n>3&&e&&Object.defineProperty(i,a,e),e};let b=class extends S{constructor(){super(...arguments),this.siwx=m.state.siwx,this.onOtpSubmit=async t=>{await this.siwx.confirmEmailOtp({code:t}),h.replace("SIWXSignMessage")},this.onOtpResend=async t=>{const i=g.getAccountData();if(!(i!=null&&i.caipAddress))throw new Error("No account data found");await this.siwx.requestEmailOtp({email:t,account:i.caipAddress})}}connectedCallback(){(!this.siwx||!(this.siwx instanceof v))&&p.showError("ReownAuthentication is not initialized."),super.connectedCallback()}shouldSubmitOnOtpChange(){return this.otp.length===S.OTP_LENGTH}};O([u()],b.prototype,"siwx",void 0);b=O([x("w3m-data-capture-otp-confirm-view")],b);const j=$`
  .hero {
    display: flex;
    flex-direction: column;
    align-items: center;
