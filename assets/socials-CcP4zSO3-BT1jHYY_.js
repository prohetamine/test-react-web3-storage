import{c as L,k as A,V as h,m as $,S as n,C as d,J as E,b as u,e as b,L as C,g as O,d as P,Z as g,i as y,H as R,h as U,l as _,_ as k,O as F,Q as c,n as W,j as D,v as N,u as j,w as q,s as I}from"./index-Cu-0-v6d.js";const z=k`
  :host {
...
`;var v=function(e,t,o,s){var r=arguments.length,i=r<3?t:s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,s);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let p=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=W.state.plan.hasExceededUsageLimit,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;let t=((e=this.remoteFeatures)==null?void 0:e.socials)||[];const o=!!this.authConnector,s=t?.length,r=g.state.view==="ConnectSocials";return(!o||!s)&&!r?null:(r&&!s&&(t=D.DEFAULT_SOCIALS),n` <wui-flex flexDirection="column" gap="2">
      ${t.map(i=>n`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){g.push("UsageExceeded");return}e&&await N(e)}async handlePwaFrameLoad(){var e;if(b.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof j&&await this.authConnector.provider.init()}catch(t){q.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:t.message},"error")}finally{this.isPwaLoading=!1}}}};p.styles=z;v([F()],p.prototype,"tabIdx",void 0);v([c()],p.prototype,"connectors",void 0);v([c()],p.prototype,"authConnector",void 0);v([c()],p.prototype,"remoteFeatures",void 0);v([c()],p.prototype,"isPwaLoading",void 0);v([c()],p.prototype,"hasExceededUsageLimit",void 0);p=v([I("w3m-social-login-list")],p);const G=k`
  wui-flex {
