import{eh as l,ei as u,ej as m,ek as n,dT as p,dW as o,em as x}from"./index-3pVASmuD.js";const b=l`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var a=function(e,r,s,h){var d=arguments.length,i=d<3?r:h,g;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,r,s,h);else for(var c=e.length-1;c>=0;c--)(g=e[c])&&(i=(d<3?g(i):d>3?g(r,s,i):g(r,s))||i);return d>3&&i&&Object.defineProperty(r,s,i),i};const f={lg:"lg-regular",md:"lg-regular",sm:"md-regular"},w={lg:"lg",md:"md",sm:"sm"};let t=class extends p{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.text="",this.loading=!1}render(){return this.loading?o` <wui-flex alignItems="center" gap="01" padding="01">
