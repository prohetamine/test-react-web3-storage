import{dT as P,e3 as y,e0 as $,dW as u,ey as h,ez as E,d_ as _,dU as M,e7 as O,e8 as K,e9 as F,eh as I,eg as l,ek as w,ei as V,ej as Q,ee as H,em as A}from"./index-Cu-0-v6d.js";import{a as n}from"./SwapController-sdd06QrK-DYgOj619.js";import"./index-BXr9RasP-CJSgTlNM.js";const q={numericInputKeyDown(e,t,o){const a=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,r=i.toLocaleLowerCase(),c=r==="a",D=r==="c",U=r==="v",R=r==="x",j=i===",",N=i===".",z=i>="0"&&i<="9";!s&&(c||D||U||R)&&e.preventDefault(),t==="0"&&!j&&!N&&i==="0"&&e.preventDefault(),t==="0"&&z&&(o(i),e.preventDefault()),(j||N)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!z&&!a.includes(i)&&!N&&!j&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
