import{x as l,B as n,V as r,I as g,q as s,W as d}from"./property-Bd8U3_QP-CBnpnfGE.js";var Z=Object.defineProperty,c=Object.getOwnPropertyDescriptor,H=(e,V,h,o)=>{for(var a=o>1?void 0:o?c(V,h):V,i=e.length-1,p;i>=0;i--)(p=e[i])&&(a=(o?p(V,h,a):p(a))||a);return o&&a&&Z(V,h,a),a};let t=class extends l{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var e;return n`<svg
  ...
  `;H([s({type:String,reflect:!0})],t.prototype,"size",2);H([s({type:String,reflect:!0})],t.prototype,"weight",2);H([s({type:String,reflect:!0})],t.prototype,"color",2);H([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=H([d("ph-copy")],t);export{t as PhCopy};
