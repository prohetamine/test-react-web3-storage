import{c as g,J as d,V as p,S as h,A as S,z as D,Z as s,b as c,i as f,C as k,d as O,H as I,e as y,f as $,p as T,_ as F,Q as v,W as N,s as u}from"./index-3pVASmuD.js";import{u as b}from"./index-BsxJaSgz-aW8G0Q-B.js";var P=function(t,e,a,n){var r=arguments.length,i=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,a):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let A=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async t=>{var e,a;try{if(this.authConnector){const n=k.state.activeChain,r=O.getConnections(n),i=(e=p.state.remoteFeatures)==null?void 0:e.multiWallet,o=r.length>0;if(await this.authConnector.provider.connectOtp({otp:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await O.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((a=p.state.remoteFeatures)!=null&&a.emailCapture)return;if(p.state.siwx){I.close();return}if(o&&i){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}I.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:y.parseError(n)}}),n}},this.onOtpResend=async t=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};A=P([u("w3m-email-verify-otp-view")],A);const W=F`
  wui-icon-box {
