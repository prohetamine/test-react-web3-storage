import{x as p,B as A,V as r,I as Z,q as i,W as n}from"./property-Bd8U3_QP-CBnpnfGE.js";var v=Object.defineProperty,g=Object.getOwnPropertyDescriptor,h=(a,s,H,o)=>{for(var e=o>1?void 0:o?g(s,H):s,l=a.length-1,V;l>=0;l--)(V=a[l])&&(e=(o?V(s,H,e):V(e))||e);return o&&e&&v(s,H,e),e};let t=class extends p{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return A`<svg
  ...
  `;h([i({type:String,reflect:!0})],t.prototype,"size",2);h([i({type:String,reflect:!0})],t.prototype,"weight",2);h([i({type:String,reflect:!0})],t.prototype,"color",2);h([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=h([n("ph-device-mobile")],t);export{t as PhDeviceMobile};
