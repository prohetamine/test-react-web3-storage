import{c as P,C as y,Z as $,S as u,x as h,y as E,e as _,H as M,b as z,o as K,$ as F,_ as I,Q as l,O as w,q as V,B as Q,j as q,s as A}from"./index-DYqKnSl7.js";import{a as n}from"./SwapController-u5L-lUFX-DcmqcoZF.js";import"./index-DB1S89dq-CVHtvwDi.js";const H={numericInputKeyDown(e,t,o){const a=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,r=i.toLocaleLowerCase(),c=r==="a",D=r==="c",U=r==="v",R=r==="x",j=i===",",N=i===".",O=i>="0"&&i<="9";!s&&(c||D||U||R)&&e.preventDefault(),t==="0"&&!j&&!N&&i==="0"&&e.preventDefault(),t==="0"&&O&&(o(i),e.preventDefault()),(j||N)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!O&&!a.includes(i)&&!N&&!j&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
...
`;var W=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let L=class extends P{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};L.styles=[Z];W([w()],L.prototype,"target",void 0);L=W([A("w3m-swap-input-skeleton")],L);const X=I`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var T=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};const J=5e-5;let b=class extends P{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return u`
      <wui-flex
    ...
    `:u` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){const e=h.multiply(this.balance,this.price),t=e?e?.gt(J):!1;return u`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){z.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),$.push("SwapSelectToken",{target:this.target})}onBuyToken(){$.push("OnRampProviders")}};b.styles=[X];T([w()],b.prototype,"focused",void 0);T([w()],b.prototype,"balance",void 0);T([w()],b.prototype,"value",void 0);T([w()],b.prototype,"price",void 0);T([w()],b.prototype,"marketValue",void 0);T([w()],b.prototype,"disabled",void 0);T([w()],b.prototype,"target",void 0);T([w()],b.prototype,"token",void 0);T([w()],b.prototype,"onSetAmount",void 0);T([w()],b.prototype,"onSetMaxValue",void 0);b=T([A("w3m-swap-input")],b);const ee=I`
...
`;var v=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let f=class extends P{constructor(){var e;super(),this.unsubscribe=[],this.targetToken=(e=$.state.data)==null?void 0:e.target,this.sourceToken=n.state.sourceToken,this.sourceTokenAmount=n.state.sourceTokenAmount,this.toToken=n.state.toToken,this.myTokensWithBalance=n.state.myTokensWithBalance,this.popularTokens=n.state.popularTokens,this.suggestedTokens=n.state.suggestedTokens,this.tokensLoading=n.state.tokensLoading,this.searchValue="",this.unsubscribe.push(n.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.myTokensWithBalance=t.myTokensWithBalance,this.popularTokens=t.popularTokens,this.suggestedTokens=t.suggestedTokens,this.tokensLoading=t.tokensLoading}))}async firstUpdated(){await n.getTokenList()}updated(){var e,t;const o=(e=this.renderRoot)==null?void 0:e.querySelector(".suggested-tokens-container");o?.addEventListener("scroll",this.handleSuggestedTokensScroll.bind(this));const a=(t=this.renderRoot)==null?void 0:t.querySelector(".tokens");a?.addEventListener("scroll",this.handleTokenListScroll.bind(this))}disconnectedCallback(){var e,t;super.disconnectedCallback();const o=(e=this.renderRoot)==null?void 0:e.querySelector(".suggested-tokens-container"),a=(t=this.renderRoot)==null?void 0:t.querySelector(".tokens");o?.removeEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),a?.removeEventListener("scroll",this.handleTokenListScroll.bind(this)),clearInterval(this.interval)}render(){return u`
    ...
    `:null}onSearchInputChange(e){this.searchValue=e.detail}handleSuggestedTokensScroll(){var e;const t=(e=this.renderRoot)==null?void 0:e.querySelector(".suggested-tokens-container");t&&(t.style.setProperty("--suggested-tokens-scroll--left-opacity",E.interpolate([0,100],[0,1],t.scrollLeft).toString()),t.style.setProperty("--suggested-tokens-scroll--right-opacity",E.interpolate([0,100],[0,1],t.scrollWidth-t.scrollLeft-t.offsetWidth).toString()))}handleTokenListScroll(){var e;const t=(e=this.renderRoot)==null?void 0:e.querySelector(".tokens");t&&(t.style.setProperty("--tokens-scroll--top-opacity",E.interpolate([0,100],[0,1],t.scrollTop).toString()),t.style.setProperty("--tokens-scroll--bottom-opacity",E.interpolate([0,100],[0,1],t.scrollHeight-t.scrollTop-t.offsetHeight).toString()))}filterTokensWithText(e,t){return e.filter(o=>`${o.symbol} ${o.name} ${o.address}`.toLowerCase().includes(t.toLowerCase())).sort((o,a)=>{const s=`${o.symbol} ${o.name} ${o.address}`.toLowerCase(),i=`${a.symbol} ${a.name} ${a.address}`.toLowerCase(),r=s.indexOf(t.toLowerCase()),c=i.indexOf(t.toLowerCase());return r-c})}};f.styles=ae;v([l()],f.prototype,"interval",void 0);v([l()],f.prototype,"targetToken",void 0);v([l()],f.prototype,"sourceToken",void 0);v([l()],f.prototype,"sourceTokenAmount",void 0);v([l()],f.prototype,"toToken",void 0);v([l()],f.prototype,"myTokensWithBalance",void 0);v([l()],f.prototype,"popularTokens",void 0);v([l()],f.prototype,"suggestedTokens",void 0);v([l()],f.prototype,"tokensLoading",void 0);v([l()],f.prototype,"searchValue",void 0);f=v([A("w3m-swap-select-token-view")],f);export{p as W3mSwapPreviewView,f as W3mSwapSelectTokenView,d as W3mSwapView};
