import{dT as P,e3 as y,e0 as $,dW as u,ey as h,ez as E,d_ as _,dU as M,e7 as O,e8 as K,e9 as F,eh as I,eg as l,ek as w,ei as V,ej as Q,ee as H,em as A}from"./index-3pVASmuD.js";import{a as n}from"./SwapController-BMGCpytT-BunOmWyw.js";import"./index-DRGq-Rwj-DTZG1_Li.js";const q={numericInputKeyDown(e,t,o){const a=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,r=i.toLocaleLowerCase(),c=r==="a",D=r==="c",U=r==="v",R=r==="x",j=i===",",N=i===".",z=i>="0"&&i<="9";!s&&(c||D||U||R)&&e.preventDefault(),t==="0"&&!j&&!N&&i==="0"&&e.preventDefault(),t==="0"&&z&&(o(i),e.preventDefault()),(j||N)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!z&&!a.includes(i)&&!N&&!j&&e.preventDefault()}},G=I`
  :host {
    width: 100%;
  }
...
`;var x=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};const Y=H.CONVERT_SLIPPAGE_TOLERANCE;let k=class extends P{constructor(){var e;super(),this.unsubscribe=[],this.networkName=(e=y.state.activeCaipNetwork)==null?void 0:e.name,this.detailsOpen=!1,this.sourceToken=n.state.sourceToken,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.priceImpact=n.state.priceImpact,this.maxSlippage=n.state.maxSlippage,this.networkTokenSymbol=n.state.networkTokenSymbol,this.inputError=n.state.inputError,this.unsubscribe.push(n.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.priceImpact=t.priceImpact,this.maxSlippage=t.maxSlippage,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError}))}render(){const e=this.toTokenAmount&&this.maxSlippage?h.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};k.styles=[G];x([l()],k.prototype,"networkName",void 0);x([w()],k.prototype,"detailsOpen",void 0);x([l()],k.prototype,"sourceToken",void 0);x([l()],k.prototype,"toToken",void 0);x([l()],k.prototype,"toTokenAmount",void 0);x([l()],k.prototype,"sourceTokenPriceInUSD",void 0);x([l()],k.prototype,"toTokenPriceInUSD",void 0);x([l()],k.prototype,"priceImpact",void 0);x([l()],k.prototype,"maxSlippage",void 0);x([l()],k.prototype,"networkTokenSymbol",void 0);x([l()],k.prototype,"inputError",void 0);k=x([A("w3m-swap-details")],k);const J=I`
  :host {
    width: 100%;
  }
...
`;var W=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let L=class extends P{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};L.styles=[J];W([w()],L.prototype,"target",void 0);L=W([A("w3m-swap-input-skeleton")],L);const X=I`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var T=function(e,t,o,a){var s=arguments.length,i=s<3?t:a,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(i=(s<3?r(i):s>3?r(t,o,i):r(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};const Z=5e-5;let f=class extends P{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return u`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){O.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),$.push("SwapSelectToken",{target:this.target})}onBuyToken(){$.push("OnRampProviders")}};f.styles=[X];T([w()],f.prototype,"focused",void 0);T([w()],f.prototype,"balance",void 0);T([w()],f.prototype,"value",void 0);T([w()],f.prototype,"price",void 0);T([w()],f.prototype,"marketValue",void 0);T([w()],f.prototype,"disabled",void 0);T([w()],f.prototype,"target",void 0);T([w()],f.prototype,"token",void 0);T([w()],f.prototype,"onSetAmount",void 0);T([w()],f.prototype,"onSetMaxValue",void 0);f=T([A("w3m-swap-input")],f);const ee=I`
