import{c as g,J as d,V as p,_ as h,A as S,b as D,Z as s,d as c,i as f,v as k,t as O,H as I,a as y,h as $,f as T,g as F,Q as v,j as N,s as u}from"./index-CrL8NvNS.js";import{u as b}from"./index-_gmT4On6-B5l7qe93.js";var P=function(t,e,a,n){var r=arguments.length,i=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,a):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let A=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async t=>{var e,a;try{if(this.authConnector){const n=k.state.activeChain,r=O.getConnections(n),i=(e=p.state.remoteFeatures)==null?void 0:e.multiWallet,o=r.length>0;if(await this.authConnector.provider.connectOtp({otp:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await O.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((a=p.state.remoteFeatures)!=null&&a.emailCapture)return;if(p.state.siwx){I.close();return}if(o&&i){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}I.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:y.parseError(n)}}),n}},this.onOtpResend=async t=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};A=P([u("w3m-email-verify-otp-view")],A);const j=F`
  wui-icon-box {
    height: ${({spacing:t})=>t[16]};
    width: ${({spacing:t})=>t[16]};
  }
`;var _=function(t,e,a,n){var r=arguments.length,i=r<3?e:n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let w=class extends g{constructor(){var t;super(),this.email=(t=s.state.data)==null?void 0:t.email,this.authConnector=d.getAuthConnector(),this.loading=!1,this.listenForDeviceApproval()}render(){if(!this.email)throw new Error("w3m-email-verify-device-view: No email provided");if(!this.authConnector)throw new Error("w3m-email-verify-device-view: No auth connector provided");return h`
      <wui-flex
...
`;var C=function(t,e,a,n){var r=arguments.length,i=r<3?e:n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let m=class extends g{constructor(){var t,e;super(...arguments),this.formRef=$(),this.initialEmail=((t=s.state.data)==null?void 0:t.email)??"",this.redirectView=(e=s.state.data)==null?void 0:e.redirectView,this.email="",this.loading=!1}firstUpdated(){var t;(t=this.formRef.value)==null||t.addEventListener("keydown",e=>{e.key==="Enter"&&this.onSubmitEmail(e)})}render(){return h`
    ...
    `}onEmailInputChange(t){this.email=t.detail}async onSubmitEmail(t){try{if(this.loading)return;this.loading=!0,t.preventDefault();const e=d.getAuthConnector();if(!e)throw new Error("w3m-update-email-wallet: Auth connector not found");const a=await e.provider.updateEmail({email:this.email});c.sendEvent({type:"track",event:"EMAIL_EDIT"}),a.action==="VERIFY_SECONDARY_OTP"?s.push("UpdateEmailSecondaryOtp",{email:this.initialEmail,newEmail:this.email,redirectView:this.redirectView}):s.push("UpdateEmailPrimaryOtp",{email:this.initialEmail,newEmail:this.email,redirectView:this.redirectView})}catch(e){f.showError(e),this.loading=!1}}buttonsTemplate(){const t=!this.loading&&this.email.length>3&&this.email!==this.initialEmail;return this.redirectView?h`
      <wui-flex gap="3">
