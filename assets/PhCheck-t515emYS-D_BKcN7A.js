import{x as n,B as c,V as r,I as d,q as i,W as u}from"./property-Bd8U3_QP-CBnpnfGE.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,l=(a,s,h,o)=>{for(var e=o>1?void 0:o?y(s,h):s,p=a.length-1,g;p>=0;p--)(g=a[p])&&(e=(o?g(s,h,e):g(e))||e);return o&&e&&w(s,h,e),e};let t=class extends n{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;l([i({type:String,reflect:!0})],t.prototype,"size",2);l([i({type:String,reflect:!0})],t.prototype,"weight",2);l([i({type:String,reflect:!0})],t.prototype,"color",2);l([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=l([u("ph-check")],t);export{t as PhCheck};
