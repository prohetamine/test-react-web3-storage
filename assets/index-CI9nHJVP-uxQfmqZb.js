import{a5 as Ee,ab as y,O as k,d as M,a as R,F as x,i as _,M as ke,v as m,ac as I,b as A,t as N,H as G,a9 as Ne,aa as Te,c as S,J as E,_ as l,m as g,G as Pe,ad as be,Z as z,ae as Se,af as Ce,ag as $e,V as re,ah as de,g as O,q as xe,k as _e,N as b,Q as h,U as Re,j as Oe,E as pe,s as C}from"./index-CrL8NvNS.js";const Ue=O`
  :host {
    position: relative;
  }
...
`;var B=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let P=class extends S{constructor(){super(),this.unsubscribe=[],this.amount=c.state.amount,this.namespace=void 0,this.paymentAsset=c.state.paymentAsset,this.activeConnectorIds=E.state.activeConnectorIds,this.caipAddress=void 0,this.exchanges=c.state.exchanges,this.isLoading=c.state.isLoading,this.initializeNamespace(),this.unsubscribe.push(c.subscribeKey("amount",e=>this.amount=e)),this.unsubscribe.push(E.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e)),this.unsubscribe.push(c.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(c.subscribeKey("isLoading",e=>this.isLoading=e)),c.fetchExchanges(),c.setSelectedExchange(void 0)}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}payWithWalletTemplate(){return Xe(this.paymentAsset.network)?this.caipAddress?this.connectedWalletTemplate():this.disconnectedWalletTemplate():l``}connectedWalletTemplate(){const{name:e,image:t}=this.getWalletProperties({namespace:this.namespace});return l`
    ...
    >
      ...
      </wui-flex>`;const e=this.exchanges.filter(t=>et(this.paymentAsset)?t.id===he:t.id!==he);return e.length===0?l`<wui-flex justifyContent="center" alignItems="center">
      ...
      `)}templateSeparator(){return l`<wui-separator text="or" bgColor="secondary"></wui-separator>`}async onWalletPayment(){if(!this.namespace)throw new Error("Namespace not found");this.caipAddress?z.push("PayQuote"):(await E.connect(),await G.open({view:"PayQuote"}))}onExchangePayment(e){c.setSelectedExchange(e),z.push("PayQuote")}async onDisconnect(){try{await N.disconnect(),await G.open({view:"Pay"})}catch{console.error("Failed to disconnect"),_.showError("Failed to disconnect")}}getWalletProperties({namespace:e}){if(!e)return{name:void 0,image:void 0};const t=this.activeConnectorIds[e];if(!t)return{name:void 0,image:void 0};const i=E.getConnector({id:t,namespace:e});if(!i)return{name:void 0,image:void 0};const s=k.getConnectorImage(i);return{name:i.name,image:s}}};P.styles=st;B([h()],P.prototype,"amount",void 0);B([h()],P.prototype,"namespace",void 0);B([h()],P.prototype,"paymentAsset",void 0);B([h()],P.prototype,"activeConnectorIds",void 0);B([h()],P.prototype,"caipAddress",void 0);B([h()],P.prototype,"exchanges",void 0);B([h()],P.prototype,"isLoading",void 0);P=B([C("w3m-pay-view")],P);const nt=O`
  :host {
    display: inline-flex;
    align-items: center;
    justify-content: center;
...
`;var j=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};const at=3,rt=2,ot=.3,ct="200px",ut={"accent-primary":Re.tokens.core.backgroundAccentPrimary};let L=class extends S{constructor(){super(...arguments),this.rings=at,this.duration=rt,this.opacity=ot,this.size=ct,this.variant="accent-primary"}render(){const e=ut[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,t){const i=`animation-delay: ${e/t*this.duration}s;`;return l`<div class="pulse-ring" style=${i}></div>`}};L.styles=[xe,nt];j([b({type:Number})],L.prototype,"rings",void 0);j([b({type:Number})],L.prototype,"duration",void 0);j([b({type:Number})],L.prototype,"opacity",void 0);j([b()],L.prototype,"size",void 0);j([b()],L.prototype,"variant",void 0);L=j([C("wui-pulse")],L);const ye=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],fe=["success","submitted","failure","timeout","refund"],lt=O`
  :host {
    display: block;
    height: 100%;
    width: 100%;
...
`;var $=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};const dt={received:["pending","success","submitted"],processing:["success","submitted"],sending:["success","submitted"]},pt=3e3;let v=class extends S{constructor(){super(),this.unsubscribe=[],this.pollingInterval=null,this.paymentAsset=c.state.paymentAsset,this.quoteStatus=c.state.quoteStatus,this.quote=c.state.quote,this.amount=c.state.amount,this.namespace=void 0,this.caipAddress=void 0,this.profileName=null,this.activeConnectorIds=E.state.activeConnectorIds,this.selectedExchange=c.state.selectedExchange,this.initializeNamespace(),this.unsubscribe.push(c.subscribeKey("quoteStatus",e=>this.quoteStatus=e),c.subscribeKey("quote",e=>this.quote=e),E.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e),c.subscribeKey("selectedExchange",e=>this.selectedExchange=e))}connectedCallback(){super.connectedCallback(),this.startPolling()}disconnectedCallback(){super.disconnectedCallback(),this.stopPolling(),this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}renderWalletText(){var e;const{image:t}=this.getWalletProperties({namespace:this.namespace}),{address:i}=this.caipAddress?y.parseCaipAddress(this.caipAddress):{},s=(e=this.selectedExchange)==null?void 0:e.name;return this.selectedExchange?l`
      ...
      <wui-flex alignItems="center" justifyContent="flex-end" gap="1">
        <wui-text variant="lg-regular" color="primary">
          ${Pe.getTruncateString({string:this.profileName||i||s||"",charsStart:this.profileName?16:4,charsEnd:this.profileName?0:6,truncate:this.profileName?"end":"middle"})}
        </wui-text>

        <wui-image src=${g(t)} size="mdl"></wui-image>
      </wui-flex>
    `}getStepsWithStatus(){return this.quoteStatus==="failure"||this.quoteStatus==="timeout"||this.quoteStatus==="refund"?ye.map(e=>({...e,status:"failed"})):ye.map(e=>{const t=(dt[e.id]??[]).includes(this.quoteStatus)?"completed":"pending";return{...e,status:t}})}renderStep({title:e,icon:t,status:i}){return l`
      <wui-flex alignItems="center" gap="3">
        <wui-flex justifyContent="center" alignItems="center" class="step-icon-container">
          <wui-icon name=${t} color="default" size="mdl"></wui-icon>

          <wui-flex alignItems="center" justifyContent="center" class=${be({"step-icon-box":!0,success:i==="completed"})}>
    ...
    `}renderStatusIndicator(e){return e==="completed"?l`<wui-icon size="sm" color="success" name="checkmark"></wui-icon>`:e==="failed"?l`<wui-icon size="sm" color="error" name="close"></wui-icon>`:e==="pending"?l`<wui-loading-spinner color="accent-primary" size="sm"></wui-loading-spinner>`:null}startPolling(){this.pollingInterval||(this.fetchQuoteStatus(),this.pollingInterval=setInterval(()=>{this.fetchQuoteStatus()},pt))}stopPolling(){this.pollingInterval&&(clearInterval(this.pollingInterval),this.pollingInterval=null)}async fetchQuoteStatus(){const e=c.state.requestId;if(!e||fe.includes(this.quoteStatus))this.stopPolling();else try{await c.fetchQuoteStatus({requestId:e}),fe.includes(this.quoteStatus)&&this.stopPolling()}catch{this.stopPolling()}}initializeNamespace(){var e,t;const i=m.state.activeChain;this.namespace=i,this.caipAddress=(e=m.getAccountData(i))==null?void 0:e.caipAddress,this.profileName=((t=m.getAccountData(i))==null?void 0:t.profileName)??null,this.unsubscribe.push(m.subscribeChainProp("accountState",s=>{this.caipAddress=s?.caipAddress,this.profileName=s?.profileName??null},i))}getWalletProperties({namespace:e}){if(!e)return{name:void 0,image:void 0};const t=this.activeConnectorIds[e];if(!t)return{name:void 0,image:void 0};const i=E.getConnector({id:t,namespace:e});if(!i)return{name:void 0,image:void 0};const s=k.getConnectorImage(i);return{name:i.name,image:s}}};v.styles=lt;$([h()],v.prototype,"paymentAsset",void 0);$([h()],v.prototype,"quoteStatus",void 0);$([h()],v.prototype,"quote",void 0);$([h()],v.prototype,"amount",void 0);$([h()],v.prototype,"namespace",void 0);$([h()],v.prototype,"caipAddress",void 0);$([h()],v.prototype,"profileName",void 0);$([h()],v.prototype,"activeConnectorIds",void 0);$([h()],v.prototype,"selectedExchange",void 0);v=$([C("w3m-pay-loading-view")],v);const ht=Oe`
  :host {
    display: block;
  }
`;var mt=function(e,t,i,s){var a=arguments.length,n=a<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,i):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let ne=class extends S{render(){return l`
    ...
    `}};ne.styles=[ht];ne=mt([C("w3m-pay-fees-skeleton")],ne);const gt=O`
  :host {
    display: block;
  }
...
`;var ve=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let H=class extends S{constructor(){super(),this.unsubscribe=[],this.quote=c.state.quote,this.unsubscribe.push(c.subscribeKey("quote",e=>this.quote=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e,t,i;const s=x.formatNumber(((e=this.quote)==null?void 0:e.origin.amount)||"0",{decimals:((t=this.quote)==null?void 0:t.origin.currency.metadata.decimals)??0,round:6}).toString();return l`
      <wui-flex flexDirection="column" gap="4">
        <wui-flex alignItems="center" justifyContent="space-between">
          <wui-text variant="md-regular" color="secondary">Pay</wui-text>
    ...
    `}};H.styles=[gt];ve([h()],H.prototype,"quote",void 0);H=ve([C("w3m-pay-fees")],H);const wt=O`
  :host {
    display: block;
    width: 100%;
  }
...
`;var Ae=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let K=class extends S{constructor(){super(),this.unsubscribe=[],this.selectedExchange=c.state.selectedExchange,this.unsubscribe.push(c.subscribeKey("selectedExchange",e=>this.selectedExchange=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=!!this.selectedExchange;return l`
    ...
    `}dispatchConnectOtherWalletEvent(){this.dispatchEvent(new CustomEvent("connectOtherWallet",{detail:!0,bubbles:!0,composed:!0}))}};K.styles=[wt];Ae([b({type:Array})],K.prototype,"selectedExchange",void 0);K=Ae([C("w3m-pay-options-empty")],K);const yt=O`
  :host {
    display: block;
    width: 100%;
  }
...
`;var ft=function(e,t,i,s){var a=arguments.length,n=a<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,i):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};let ae=class extends S{render(){return l`
    ...
    `}};ae.styles=[yt];ae=ft([C("w3m-pay-options-skeleton")],ae);const bt=O`
  :host {
    display: block;
    width: 100%;
  }
...
`;var X=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};const xt=300;let F=class extends S{constructor(){super(),this.unsubscribe=[],this.options=[],this.selectedPaymentAsset=null}disconnectedCallback(){var e,t;this.unsubscribe.forEach(s=>s()),(e=this.resizeObserver)==null||e.disconnect();const i=(t=this.shadowRoot)==null?void 0:t.querySelector(".pay-options-container");i?.removeEventListener("scroll",this.handleOptionsListScroll.bind(this))}firstUpdated(){var e,t;const i=(e=this.shadowRoot)==null?void 0:e.querySelector(".pay-options-container");i&&(requestAnimationFrame(this.handleOptionsListScroll.bind(this)),i?.addEventListener("scroll",this.handleOptionsListScroll.bind(this)),this.resizeObserver=new ResizeObserver(()=>{this.handleOptionsListScroll()}),(t=this.resizeObserver)==null||t.observe(i),this.handleOptionsListScroll())}render(){return l`
    ...
    `}handleOptionsListScroll(){var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector(".pay-options-container");t&&(t.scrollHeight>xt?(t.style.setProperty("--options-mask-image",`linear-gradient(
          to bottom,
...
`;var f=function(e,t,i,s){var a=arguments.length,n=a<3?t:s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,s);else for(var u=e.length-1;u>=0;u--)(o=e[u])&&(n=(a<3?o(n):a>3?o(t,i,n):o(t,i))||n);return a>3&&n&&Object.defineProperty(t,i,n),n};const V={eip155:"ethereum",solana:"solana",bip122:"bitcoin",ton:"ton"},At={eip155:{icon:V.eip155,label:"EVM"},solana:{icon:V.solana,label:"Solana"},bip122:{icon:V.bip122,label:"Bitcoin"},ton:{icon:V.ton,label:"Ton"}};let w=class extends S{constructor(){super(),this.unsubscribe=[],this.profileName=null,this.paymentAsset=c.state.paymentAsset,this.namespace=void 0,this.caipAddress=void 0,this.amount=c.state.amount,this.recipient=c.state.recipient,this.activeConnectorIds=E.state.activeConnectorIds,this.selectedPaymentAsset=c.state.selectedPaymentAsset,this.selectedExchange=c.state.selectedExchange,this.isFetchingQuote=c.state.isFetchingQuote,this.quoteError=c.state.quoteError,this.quote=c.state.quote,this.isFetchingTokenBalances=c.state.isFetchingTokenBalances,this.tokenBalances=c.state.tokenBalances,this.isPaymentInProgress=c.state.isPaymentInProgress,this.exchangeUrlForQuote=c.state.exchangeUrlForQuote,this.completedTransactionsCount=0,this.unsubscribe.push(c.subscribeKey("paymentAsset",e=>this.paymentAsset=e)),this.unsubscribe.push(c.subscribeKey("tokenBalances",e=>this.onTokenBalancesChanged(e))),this.unsubscribe.push(c.subscribeKey("isFetchingTokenBalances",e=>this.isFetchingTokenBalances=e)),this.unsubscribe.push(E.subscribeKey("activeConnectorIds",e=>this.activeConnectorIds=e)),this.unsubscribe.push(c.subscribeKey("selectedPaymentAsset",e=>this.selectedPaymentAsset=e)),this.unsubscribe.push(c.subscribeKey("isFetchingQuote",e=>this.isFetchingQuote=e)),this.unsubscribe.push(c.subscribeKey("quoteError",e=>this.quoteError=e)),this.unsubscribe.push(c.subscribeKey("quote",e=>this.quote=e)),this.unsubscribe.push(c.subscribeKey("amount",e=>this.amount=e)),this.unsubscribe.push(c.subscribeKey("recipient",e=>this.recipient=e)),this.unsubscribe.push(c.subscribeKey("isPaymentInProgress",e=>this.isPaymentInProgress=e)),this.unsubscribe.push(c.subscribeKey("selectedExchange",e=>this.selectedExchange=e)),this.unsubscribe.push(c.subscribeKey("exchangeUrlForQuote",e=>this.exchangeUrlForQuote=e)),this.resetQuoteState(),this.initializeNamespace(),this.fetchTokens()}disconnectedCallback(){super.disconnectedCallback(),this.resetAssetsState(),this.unsubscribe.forEach(e=>e())}updated(e){super.updated(e),e.has("selectedPaymentAsset")&&this.fetchQuote()}render(){return l`
    ...
    `}profileTemplate(){var e,t;if(this.selectedExchange){const u=x.formatNumber((e=this.quote)==null?void 0:e.origin.amount,{decimals:((t=this.quote)==null?void 0:t.origin.currency.metadata.decimals)??0}).toString();return l`
      ...
      `}const i=R.getPlainAddress(this.caipAddress)??"",{name:s,image:a}=this.getWalletProperties({namespace:this.namespace}),{icon:n,label:o}=At[this.namespace]??{};return l`
      <wui-flex
        .padding=${["4","3","4","3"]}
        alignItems="center"
        justifyContent="space-between"
      ...
      <wui-flex alignItems="center" justifyContent="space-between">
        <wui-flex flexDirection="column" gap="1">
          ...
          ${s||a?l`<wui-shimmer width="58px" height="32px" variant="light"></wui-shimmer>`:l`<wui-flex alignItems="center" gap="01">
                <wui-text variant="h4-regular" color="primary">${Y(n)}</wui-text>
