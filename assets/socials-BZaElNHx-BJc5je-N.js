import{dT as L,eq as A,dV as h,el as $,dW as n,e3 as d,dX as E,e7 as u,d_ as b,dY as C,er as O,ec as P,e0 as g,ea as y,dU as R,es as U,et as _,eh as k,ek as W,eg as c,eu as F,ee as D,ev as N,ew as q,ex as j,em as I}from"./index-3pVASmuD.js";const z=k`
  :host {
...
`;var v=function(e,t,o,s){var r=arguments.length,i=r<3?t:s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,s);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let p=class extends L{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=F.state.plan.hasExceededUsageLimit,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;let t=((e=this.remoteFeatures)==null?void 0:e.socials)||[];const o=!!this.authConnector,s=t?.length,r=g.state.view==="ConnectSocials";return(!o||!s)&&!r?null:(r&&!s&&(t=D.DEFAULT_SOCIALS),n` <wui-flex flexDirection="column" gap="2">
      ${t.map(i=>n`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){g.push("UsageExceeded");return}e&&await N(e)}async handlePwaFrameLoad(){var e;if(b.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof q&&await this.authConnector.provider.init()}catch(t){j.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:t.message},"error")}finally{this.isPwaLoading=!1}}}};p.styles=z;v([W()],p.prototype,"tabIdx",void 0);v([c()],p.prototype,"connectors",void 0);v([c()],p.prototype,"authConnector",void 0);v([c()],p.prototype,"remoteFeatures",void 0);v([c()],p.prototype,"isPwaLoading",void 0);v([c()],p.prototype,"hasExceededUsageLimit",void 0);p=v([I("w3m-social-login-list")],p);const G=k`
  wui-flex {
...
`;var T=function(e,t,o,s){var r=arguments.length,i=r<3?t:s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,s);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let S=class extends L{constructor(){super(),this.unsubscribe=[],this.checked=A.state.isLegalCheckboxChecked,this.unsubscribe.push(A.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var e;const{termsConditionsUrl:t,privacyPolicyUrl:o}=h.state,s=(e=h.state.features)==null?void 0:e.legalCheckbox,r=!!(t||o)&&!!s&&!this.checked,i=r?-1:void 0;return n`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","3","3","3"]}
        gap="01"
        class=${$(r?"disabled":void 0)}
      >
        <w3m-social-login-list tabIdx=${$(i)}></w3m-social-login-list>
      </wui-flex>
    `}};S.styles=G;T([c()],S.prototype,"checked",void 0);S=T([I("w3m-connect-socials-view")],S);const M=k`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var f=function(e,t,o,s){var r=arguments.length,i=r<3?t:s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,s);else for(var l=e.length-1;l>=0;l--)(a=e[l])&&(i=(r<3?a(i):r>3?a(t,o,i):a(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let m=class extends L{constructor(){var e,t,o;super(),this.unsubscribe=[],this.socialProvider=(e=d.getAccountData())==null?void 0:e.socialProvider,this.socialWindow=(t=d.getAccountData())==null?void 0:t.socialWindow,this.error=!1,this.connecting=!1,this.message="Connect in the provider window",this.remoteFeatures=h.state.remoteFeatures,this.address=(o=d.getAccountData())==null?void 0:o.address,this.connectionsByNamespace=P.getConnections(d.state.activeChain),this.hasMultipleConnections=this.connectionsByNamespace.length>0,this.authConnector=E.getAuthConnector(),this.handleSocialConnection=async s=>{var r;if((r=s.data)!=null&&r.resultUri)if(s.origin===U.SECURE_SITE_ORIGIN){window.removeEventListener("message",this.handleSocialConnection,!1);try{if(this.authConnector&&!this.connecting){this.connecting=!0;const i=this.parseURLError(s.data.resultUri);if(i){this.handleSocialError(i);return}this.closeSocialWindow(),this.updateMessage();const a=s.data.resultUri;this.socialProvider&&u.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}}),await P.connectExternal({id:this.authConnector.id,type:this.authConnector.type,socialUri:a},this.authConnector.chain),this.socialProvider&&(O.setConnectedSocialProvider(this.socialProvider),u.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider}}))}}catch(i){this.error=!0,this.updateMessage(),this.socialProvider&&u.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider,message:b.parseError(i)}})}}else g.goBack(),y.showError("Untrusted Origin"),this.socialProvider&&u.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider,message:"Untrusted Origin"}})},_.EmbeddedWalletAbortController.signal.addEventListener("abort",()=>{this.closeSocialWindow()}),this.unsubscribe.push(d.subscribeChainProp("accountState",s=>{var r;if(s&&(this.socialProvider=s.socialProvider,s.socialWindow&&(this.socialWindow=s.socialWindow),s.address)){const i=(r=this.remoteFeatures)==null?void 0:r.multiWallet;s.address!==this.address&&(this.hasMultipleConnections&&i?(g.replace("ProfileWallets"),y.showSuccess("New Wallet Added"),this.address=s.address):(R.state.open||h.state.enableEmbedded)&&R.close())}}),h.subscribeKey("remoteFeatures",s=>{this.remoteFeatures=s})),this.authConnector&&this.connectSocial()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),window.removeEventListener("message",this.handleSocialConnection,!1),!d.state.activeCaipAddress&&this.socialProvider&&!this.connecting&&u.sendEvent({type:"track",event:"SOCIAL_LOGIN_CANCELED",properties:{provider:this.socialProvider}}),this.closeSocialWindow()}render(){return n`
      <wui-flex
